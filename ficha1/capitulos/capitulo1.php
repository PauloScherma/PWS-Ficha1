...
$paragrafo1 = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer ullamcorper libero quis orci
    ...
    eu. Maecenas rhoncus quam in justo feugiat maximus.
    Duis ut euismod augue. Nam accumsan dignissim arcu, sed vulputate libero rhoncus vulputate.";
...
$paragrafo2 = "Etiam malesuada erat metus, a vehicula dui auctor sed. Morbi pretium non erat ac cursus.
    ...
    augue. Duis quam purus, blandit at turpis placerat, consectetur porta dui. Phasellus tristique diam id ex fringilla,
...
$paragrafo3 = "Sed facilisis viverra metus vel sodales. Ut nulla mi, elementum nec orci ac, tincidunt commodo leo. Ut porttitor
    ...
    nulla sagittis ex, vel pellentesque neque sem non velit. Pellentesque habitant morbi tristique senectus et netus et
    malesuada fames ac turpis egestas. Maecenas eu tortor non risus
...
<h1><?php echo $_GET['title']; ?></h1><?php echo $_GET['version']; ?>
<p><?= $paragrafo1; ?>
<p><?= $paragrafo2; ?>
<p><?= $paragrafo3; ?>
<p><?= $paragrafo4; ?>
<div><a href="../indice.php">Voltar ao indice</a></div>
</body>
</html>
